...
public partial class PeriodStats : TBase
{
  ...
  private Dictionary<string, Amount> _balancePerCurrency;
  ...
  public Dictionary<string, Amount> BalancePerCurrency
  {
    get
    {
        ...
        switch (field.ID)
        {
          ...
          case 4:
            if (field.Type == TType.Map) {
              {
                BalancePerCurrency = new Dictionary<string, Amount>();
                ...
                for( int _i1 = 0; _i1 < _map0.Count; ++_i1)
                {
                  ...
                  _val3 = new Amount();
                  _val3.Read(iprot);
                  BalancePerCurrency[_key2] = _val3;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (BalancePerCurrency != null && __isset.balancePerCurrency) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (string _iter4 in BalancePerCurrency.Keys)
          {
            oprot.WriteString(_iter4);
            BalancePerCurrency[_iter4].Write(oprot);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
