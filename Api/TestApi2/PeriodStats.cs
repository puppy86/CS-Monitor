...
namespace TestApi2
{
  ...
  public partial class PeriodStats : TBase
  {
    ...
    private CumulativeAmount _balancePerCurrency;
    ...
    public CumulativeAmount BalancePerCurrency
    {
      get
      {
          ...
          switch (field.ID)
          {
            ...
            case 4:
              if (field.Type == TType.Struct) {
                BalancePerCurrency = new CumulativeAmount();
                BalancePerCurrency.Read(iprot);
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
              break;
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (BalancePerCurrency != null && __isset.balancePerCurrency) {
          ...
          field.ID = 4;
          oprot.WriteFieldBegin(field);
          BalancePerCurrency.Write(oprot);
          oprot.WriteFieldEnd();
        }
