...
namespace TestApi2
{
  public partial class API {
    public interface ISync {
      BalanceGetResult BalanceGet(byte[] address);
      TransactionGetResult TransactionGet(TransactionId transactionId);
      TransactionsGetResult TransactionsGet(byte[] wallet, long offset, long limit);
    ...
    public interface Iface : ISync {
      #if SILVERLIGHT
      IAsyncResult Begin_BalanceGet(AsyncCallback callback, object state, byte[] address);
      ...
      #endif
      #if SILVERLIGHT
      IAsyncResult Begin_TransactionsGet(AsyncCallback callback, object state, byte[] wallet, long offset, long limit);
    ...
    public class Client : IDisposable, Iface {
      ...
      #if SILVERLIGHT
      public IAsyncResult Begin_BalanceGet(AsyncCallback callback, object state, byte[] address)
      {
        return send_BalanceGet(callback, state, address);
      }
      ...
      public BalanceGetResult BalanceGet(byte[] address)
      {
        #if !SILVERLIGHT
        send_BalanceGet(address);
        return recv_BalanceGet();

        #else
        var asyncResult = Begin_BalanceGet(null, null, address);
        return End_BalanceGet(asyncResult);

        #endif
      }
      #if SILVERLIGHT
      public IAsyncResult send_BalanceGet(AsyncCallback callback, object state, byte[] address)
      #else
      public void send_BalanceGet(byte[] address)
      #endif
      {
      ...
      #if SILVERLIGHT
      public IAsyncResult Begin_TransactionsGet(AsyncCallback callback, object state, byte[] wallet, long offset, long limit)
      {
        return send_TransactionsGet(callback, state, wallet, offset, limit);
      }
      ...
      public TransactionsGetResult TransactionsGet(byte[] wallet, long offset, long limit)
      {
        #if !SILVERLIGHT
        send_TransactionsGet(wallet, offset, limit);
        return recv_TransactionsGet();

        #else
        var asyncResult = Begin_TransactionsGet(null, null, wallet, offset, limit);
        return End_TransactionsGet(asyncResult);

        #endif
      }
      #if SILVERLIGHT
      public IAsyncResult send_TransactionsGet(AsyncCallback callback, object state, byte[] wallet, long offset, long limit)
      #else
      public void send_TransactionsGet(byte[] wallet, long offset, long limit)
      #endif
      {
    ...
    public class Processor : TProcessor {
      ...
      public void BalanceGet_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        try
        {
          result.Success = iface_.BalanceGet(args.Address);
      ...
      public void TransactionsGet_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        try
        {
          result.Success = iface_.TransactionsGet(args.Wallet, args.Offset, args.Limit);
