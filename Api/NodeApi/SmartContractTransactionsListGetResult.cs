...
namespace NodeApi
{
  ...
  [Serializable]
  #endif
  public partial class SmartContractTransactionsListGetResult : TBase
  {
    ...
    public SmartContractTransactionsListGetResult() {
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("SmartContractTransactionsListGetResult");
        ...
        if (Transactions != null && __isset.transactions) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (Transaction _iter40 in Transactions)
            {
              _iter40.Write(oprot);
            }
            oprot.WriteListEnd();
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("SmartContractTransactionsListGetResult(");
      bool __first = true;
      if (Status != null && __isset.status) {
