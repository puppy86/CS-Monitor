              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    SmartContractMethod _elem88;
                    _elem88 = new SmartContractMethod();
                    _elem88.Read(iprot);
                    Methods.Add(_elem88);
                  }
                  iprot.ReadListEnd();
      ...
      try
      {
        ...
        if (Methods != null && __isset.methods) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (SmartContractMethod _iter93 in Methods)
            {
              _iter93.Write(oprot);
            }
            oprot.WriteListEnd();
        ...
        if (Variables != null && __isset.variables) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter94 in Variables.Keys)
            {
              oprot.WriteString(_iter94);
              Variables[_iter94].Write(oprot);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
