              ...
              if (field.Type == TType.Map) {
                {
                  ...
                  {
                    sbyte _key19;
                    CumulativeAmount _val20;
                    _key19 = iprot.ReadByte();
                    _val20 = new CumulativeAmount();
                    _val20.Read(iprot);
                    BalancePerCurrency[_key19] = _val20;
                  }
                  iprot.ReadMapEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (BalancePerCurrency != null && __isset.balancePerCurrency) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (sbyte _iter21 in BalancePerCurrency.Keys)
            {
              oprot.WriteByte(_iter21);
              BalancePerCurrency[_iter21].Write(oprot);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
